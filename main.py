...
class Bank:
    ...
    def bankadd(self,account,name,password,country,province,street,doot):
        ...
        param2=[account,name,password,country,province,street,doot,self.__money,"2021-11-2",self.__bank_name]
    ...
    def useradd(self):
        ...
        doot=input("\t\t请输入您的门牌号")
        num=self.bankadd(account,name,password,country,province,street,doot)
        if num ==3:
            print("本银行已满请到其他银行开户")
        elif num== 2:
            print("用户已存在")
